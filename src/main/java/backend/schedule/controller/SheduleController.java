...
public class SheduleController {
    ...
    public ResponseEntity<Map<String, String>> updateScheduleStatus(
        ...
        checkupScheduleService.updateScheduleStatus(scheduleId, newStatus);
        return ResponseEntity.ok(Map.of("message", "Schedule status updated successfully"));
    }

    @GetMapping("/{scheduleId}/patients")
    public ResponseEntity<List<Map<String, Object>>> getPatientsByScheduleId(@PathVariable Long scheduleId) {
        return ResponseEntity.ok(checkupScheduleService.getPatientByScheduleId(scheduleId));
    }
}
